...
class HxBlit {
	...
	public static function init(__callBack:Void->Void, _width:Int = 800, _height:Int = 600,
			_zoom:Int = 2):Void {
	...
	static private function setContext3d(e:Event):Void {
		...
		context.setBlendFactors(Context3DBlendFactor.SOURCE_ALPHA,
	...
	static public function setBlendMode(_mode:String):Void {
		switch (_mode) {
			...
			case "ADDALL":
				context.setBlendFactors(Context3DBlendFactor.SOURCE_COLOR,
	...
	static public function initShader():Void {
		(cast currentShader)
			.init({mproj: matrix2}, {tex: atlas.texture});
	}
	...
	static public function clear(_r:Float = 1, _g:Float = 1, _b:Float = 1, _a:Float = 1, _d:Float = 1,
			_s:UInt = 1, _m:UInt = 0xffffffff):Void {
